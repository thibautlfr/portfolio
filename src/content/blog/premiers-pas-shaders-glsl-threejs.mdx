...
date: 2026-06-11
tags: [threejs, glsl, shaders, creative-dev, retour-experience]
project: 3d-carousel
links:
  - label: "Voir la démo"
...
Cet article, c'est un retour d'expérience. Je ne suis pas un expert en shaders. C'est mon premier projet en autonomie après m'être formé aux bases du GLSL via [Three.js Journey](https://threejs-journey.com/), la doc officielle et beaucoup d'exemples sur [Awwwards](https://www.awwwards.com/) et [Codrops](https://tympanus.net/codrops/). Mon approche : je me forme, puis je lance un truc pour tester ce que je viens d'apprendre. Pas besoin d'un brief client ou d'un projet ambitieux. Juste une idée, une commande `npm create`, et c'est parti.
...
<figure>
  <Image src={carouselResultat} alt="Carousel 3D avec aberration chromatique : trois images animées disposées en arc de cercle avec un effet de séparation des canaux RGB au survol" loading="eager" class="rounded-lg border border-neutral-200" />
  <figcaption class="text-xs text-neutral-500 mt-2 text-center">Le rendu final du carousel avec l'effet d'aberration chromatique</figcaption>
</figure>
...
Pour les shaders spécifiquement, j'utilise [vite-plugin-glsl](https://github.com/UstymUkhman/vite-plugin-glsl) qui permet d'importer les fichiers `.glsl` directement dans le TypeScript. Ça évite d'écrire du GLSL dans des template literals et ça donne le syntax highlighting dans l'IDE.
...
<iframe src="https://thibautlfr.github.io/3d-carousel/" class="w-full aspect-video rounded-lg border border-neutral-200" loading="lazy" title="Démo interactive du carousel 3D avec aberration chromatique" />
