...
<figure>
  <Image src={carouselResultat} alt="Carousel 3D avec aberration chromatique : trois images animées disposées en arc de cercle avec un effet de séparation des canaux RGB au survol" loading="eager" class="rounded-lg border border-sage-6" />
  <figcaption class="text-xs text-sage-11 mt-2 text-center">Le rendu final du carousel avec l'effet d'aberration chromatique</figcaption>
</figure>
...
<iframe src="https://thibautlfr.github.io/3d-carousel/" class="w-full aspect-video rounded-lg border border-sage-6" loading="lazy" title="Démo interactive du carousel 3D avec aberration chromatique" />
